...
We provide an example [implementation](./competition/lab_samples_logistics) of this mission using the BT.CPP framework which you can use for your own mission.
